...
class Task extends Command
{
    ...
    public function __construct($name = null)
    {
        ...
        // $this->cmd = str_replace('\\', '/', 'php think queue:listen');
        // $this->cmd = str_replace('\\', '/', 'php ' . env('ROOT_PATH') . 'think queue:listen');
        // $this->cmd = str_replace('\\', '/', 'php think queue:work --tries 1 --daemon');
        //
        // $this->cmd = str_replace('\\', '/', 'php ' . env('ROOT_PATH') . 'think queue:listen');
        $this->cmd = str_replace('\\', '/', 'php ' . env('ROOT_PATH') . 'think queue:work --tries 1 --daemon');
    }
